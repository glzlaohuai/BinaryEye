...
import com.awesomeapp.xscaner.adapter.prettifyFormatName
import com.awesomeapp.xscaner.ads.ID
import com.awesomeapp.xscaner.app.*
import com.awesomeapp.xscaner.bluetooth.sendBluetoothAsync
import com.awesomeapp.xscaner.content.copyToClipboard
import com.awesomeapp.xscaner.content.execShareIntent
import com.awesomeapp.xscaner.content.openUrl
import com.awesomeapp.xscaner.content.toHexString
import com.awesomeapp.xscaner.database.toScan
import com.awesomeapp.xscaner.graphics.FrameMetrics
import com.awesomeapp.xscaner.graphics.mapPosition
import com.awesomeapp.xscaner.graphics.setFrameRoi
import com.awesomeapp.xscaner.graphics.setFrameToView
import com.awesomeapp.xscaner.media.releaseToneGenerators
import com.awesomeapp.xscaner.net.sendAsync
import com.awesomeapp.xscaner.net.urlEncode
import com.awesomeapp.xscaner.view.errorFeedback
import com.awesomeapp.xscaner.view.initSystemBars
import com.awesomeapp.xscaner.view.scanFeedback
import com.awesomeapp.xscaner.view.setPaddingFromWindowInsets
import com.awesomeapp.xscaner.widget.DetectorView
...
class CameraActivity : AppCompatActivity(), APAdInterstitialListener {
    ...
    private var ad: APAdInterstitial? = null
    ...
    fun loadInterstitial(): Unit {
        ad?.destroy()
        ad = APAdInterstitial(ID.interstitial_id, this)
        ad?.load()
    }
    ...
    override fun onApAdInterstitialLoadSuccess(p0: APAdInterstitial?) {
        p0?.presentWithActivity(this)
    }

    override fun onApAdInterstitialLoadFail(p0: APAdInterstitial?, p1: APAdError?) {
    }

    override fun onApAdInterstitialPresentSuccess(p0: APAdInterstitial?) {
    }

    override fun onApAdInterstitialPresentFail(p0: APAdInterstitial?, p1: APAdError?) {
    }

    override fun onApAdInterstitialClick(p0: APAdInterstitial?) {
    }

    override fun onApAdInterstitialDidPresentLanding(p0: APAdInterstitial?) {
    }

    override fun onApAdInterstitialDidDismissLanding(p0: APAdInterstitial?) {
    }

    override fun onApAdInterstitialApplicationWillEnterBackground(p0: APAdInterstitial?) {
    }

    override fun onAPAdInterstitialDismiss(p0: APAdInterstitial?) {
    }
}
